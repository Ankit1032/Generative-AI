...
#This project is building the index once and stroing the results so latency drops.
"""
...
Embedding model name changes → e.g., from "text-embedding-3-small" to another model.
"""

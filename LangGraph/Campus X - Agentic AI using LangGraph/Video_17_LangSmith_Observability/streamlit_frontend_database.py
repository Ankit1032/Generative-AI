""" Video 17 - LangSmith
We dont want langsmith to show the prompts/user query of different threads in single trace
So we will configure threads in Lnagsmith
so we will make changes in CONFIG variable
"""
